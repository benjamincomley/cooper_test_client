...
.controller('AppCtrl', function($rootScope,
  ...
  // Form data for the LOG IN modal
  $scope.loginData = {};
...
// LOG IN // LOG IN // LOG IN // LOG IN// LOG IN // LOG IN // LOG IN // LOG IN
  ...
  // Create the LOG IN modal that we will use later
  ...
  // Triggered in the LOG IN modal to close it
  ...
  // Perform the LOG IN action when the user submits the LOG IN form
...
// TEST CONTROLLER // TEST CONTROLLER // TEST CONTROLLER // TEST CONTROLLER
...
// PERFORMANCE CONTROLLER // PERFORMANCE CONTROLLER // PERFORMANCE CONTROLLER
